...
public class GestionEtudiants {
    ...
    public static String im5 = "../images/image5.jpeg";*/

    /*static {
        //listeEtudiants.add(new Etudiant("1", "Yassmine", 12.0, "image1.jpeg"));
        listeEtudiants.add(new Etudiant("1", "Salma", 12.0, im1));
        listeEtudiants.add(new Etudiant("2", "Taha", 14.0,im2));
